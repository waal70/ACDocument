...
public class BatchFileWriterNIX extends BatchFileWriter {
	...
	void addMVPFunction() {
		...
		sb.append("function mvp ()"); sb.append("\n");
		sb.append("{"); sb.append("\n");
		sb.append("dir=\"$2\""); sb.append("\n");
		sb.append("tmp=\"$2\"; tmp=\"${tmp: -1}\""); sb.append("\n");
		sb.append("[ \"$tmp\" != \"/\" ] && dir=\"$(dirname \"$2\")\""); sb.append("\n");
		sb.append("[ -a \"$dir\" ] ||"); sb.append("\n");
		sb.append("mkdir -p \"$dir\" && "); sb.append("\n");
		sb.append("mv -f \"$@\""); sb.append("\n");
		sb.append("}"); sb.append("\n");
