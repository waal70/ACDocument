...
public interface PDF {
    ...
    String PDF_PREFIX = "pdf"+ACCoreProperties.NAMESPACE_PREFIX_DELIMITER;
    String PDFA_PREFIX = "pdfa"+ACCoreProperties.NAMESPACE_PREFIX_DELIMITER;
    String PDFAID_PREFIX = "pdfaid"+ACCoreProperties.NAMESPACE_PREFIX_DELIMITER;
    ...
    String PDF_DOC_INFO_PREFIX = PDF_PREFIX + "docinfo" +
            ACCoreProperties.NAMESPACE_PREFIX_DELIMITER;
