...
public interface DublinCore {
	...
	Property FORMAT = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "format");
	...
	Property IDENTIFIER = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "identifier");

    /**
     * Date on which the resource was changed.
     */
	Property MODIFIED = Property.internalDate(
		PREFIX_DC_TERMS + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "modified");
	...
	Property CONTRIBUTOR = Property.internalTextBag(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "contributor");
	...
	Property COVERAGE = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "coverage");
	...
	Property CREATOR = Property.internalTextBag(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "creator");

    /**
     * Date of creation of the resource.
     */
        Property CREATED = Property.internalDate(
                PREFIX_DC_TERMS + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "created");
	...
	Property DATE = Property.internalDate(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "date");
	...
	Property DESCRIPTION = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "description");
	...
	Property LANGUAGE = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "language");
	...
	Property PUBLISHER = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "publisher");
	...
	Property RELATION = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "relation");
	...
	Property RIGHTS = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "rights");
	...
	Property SOURCE = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "source");
	...
	Property SUBJECT = Property.internalTextBag(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "subject");
	...
	Property TITLE = Property.internalText(
    		PREFIX_DC + ACCoreProperties.NAMESPACE_PREFIX_DELIMITER + "title");
